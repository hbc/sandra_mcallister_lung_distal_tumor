...
```{r dotplotBP1, fig.width=7.5}
# Dotplot of top 25
dotplot(egoBP, showCategory = 13)
```

```{r dotplotBP2, fig.width=8}
# Dotplot of top 25
dotplot(egoBP, showCategory = 13)
```

```{r dotplotBP3, fig.widt=9}
# Dotplot of top 25
dotplot(egoBP, showCategory = 13)
```
...
```{r cnetplotbp, fig.width=6, fig.height=6}
...
gsesignedpvalue <- gseGO(
    ...
    verbose = FALSE,
    by="fgsea")
saveData(gsesignedpvalue, dir = dataDir)
...
gsepvalue <- gseGO(
    ...
    verbose = FALSE,
    by="fgsea")
saveData(gsepvalue, dir = dataDir)
